  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between space-y-2 sm:space-y-3 bg-white dark:bg-forest-900/90">
          
          <div className="space-y-1 sm:space-y-1.5">
            {/* Origin & Weight Tag */}
            <div className="flex items-center justify-between text-[9px] sm:text-[11px] text-gray-500 dark:text-gray-400 font-medium">
              <span className="truncate pr-1.5">{product.brand}</span>
              {product.weight && (
                <span className="font-semibold text-forest-800 dark:text-leaf-300 bg-sage-100 dark:bg-forest-800 px-1.5 py-0.5 rounded-full text-[8.5px] sm:text-[10px] shrink-0">
                  {product.weight}
                </span>
              )}
            </div>
            ...
            <Link
              ...
              className="block font-serif text-[12.5px] sm:text-base font-bold text-charcoal-900 dark:text-ivory-100 group-hover:text-leaf-600 dark:group-hover:text-leaf-400 transition-colors line-clamp-2 leading-snug"
            >
              {product.name}
            </Link>
          ...
          <div className="pt-1.5 sm:pt-2 border-t border-gray-100 dark:border-forest-800 flex flex-col xs:flex-row xs:items-center justify-between gap-1.5 sm:gap-2">
            ...
            <div className="flex flex-col">
              <div className="flex items-baseline gap-1 sm:gap-1.5">
                <span className="text-[13.5px] sm:text-lg font-black text-forest-900 dark:text-leaf-400 leading-none">
              ...
              {product.unit && (
                <span className="text-[9px] sm:text-[10px] text-gray-400 mt-0.5">{product.unit}</span>
              )}
            </div>

            {/* Cart Action: Quantity Stepper if in Cart, else Add Button */}
            {inCart ? (
              <div className="flex items-center bg-forest-900 dark:bg-forest-800 text-white rounded-full p-0.5 sm:p-1 border border-leaf-500/40 shadow-sm w-fit self-end xs:self-auto">
                <button
                  onClick={handleDecrement}
                  aria-label="Decrease quantity"
                  className="w-5 h-5 sm:w-7 sm:h-7 rounded-full bg-forest-800 hover:bg-forest-700 flex items-center justify-center text-leaf-400 transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-5 h-5 sm:w-7 sm:h-7 rounded-full bg-leaf-500 hover:bg-leaf-400 text-forest-950 flex items-center justify-center font-bold transition-colors cursor-pointer shadow-leaf-sm"
                >
              ...
              <button
                ...
                className={`px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-full font-bold text-[10px] sm:text-xs flex items-center justify-center gap-1 transition-all shadow-sm cursor-pointer w-fit self-end xs:self-auto ${
                  justAdded
