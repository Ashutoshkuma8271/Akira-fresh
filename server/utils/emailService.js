...
<body style="margin:0; padding:0; background-color:#030B11; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing:antialiased;">
  <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#030B11; min-height:100vh;">
    <tr>
      <td align="center" style="padding:48px 16px;">
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:540px; background:linear-gradient(180deg, #092032 0%, #051421 100%); border:1px solid rgba(212,175,55,0.35); border-radius:24px; box-shadow:0 24px 60px rgba(0,0,0,0.6); overflow:hidden;">
          <tr>
          ...
          <tr>
            <td align="center" style="padding:36px 32px 24px 32px; border-bottom:1px solid rgba(255,255,255,0.06);">
              <div style="display:inline-block; padding:7px 18px; background:rgba(245,184,61,0.08); border:1px solid rgba(245,184,61,0.3); border-radius:30px; margin-bottom:14px;">
                <span style="font-size:10px; font-weight:800; letter-spacing:2.5px; color:#F5B83D; text-transform:uppercase;">OFFICIAL VERIFICATION</span>
              </div>
              <h1 style="margin:0; font-size:24px; font-weight:800; letter-spacing:4px; color:#FFFFFF; text-transform:uppercase; font-family:'Georgia', serif;">A_S COMMERCE</h1>
              <p style="margin:4px 0 0 0; font-size:10px; letter-spacing:2.5px; color:#D4AF37; text-transform:uppercase;">Luxury Timepieces & Haute Couture</p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding:36px 36px 32px 36px;">
              ...
              <p style="margin:0 0 32px 0; font-size:13.5px; line-height:1.65; color:#9FB3C8; max-width:400px;">
                Welcome to A_S Commerce. Please enter this one-time 6-digit passcode on your screen to complete registration:
              </p>
              <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto 32px auto;">
                <tr>
                  <td align="center" style="background:radial-gradient(ellipse at center, rgba(245,184,61,0.18) 0%, rgba(11,34,56,0.8) 100%); border:1.5px solid #F5B83D; border-radius:18px; padding:22px 36px; box-shadow:0 8px 30px rgba(245,184,61,0.15);">
                    <div style="font-size:10px; font-weight:800; letter-spacing:2px; color:#D4AF37; text-transform:uppercase; margin-bottom:6px;">ONE-TIME PASSCODE</div>
                    <div style="font-size:38px; font-weight:800; letter-spacing:10px; color:#F5B83D; font-family:'Courier New', monospace; text-shadow:0 2px 10px rgba(245,184,61,0.4); padding-left:10px;">${otp}</div>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding:24px 32px; background:#02090F; border-top:1px solid rgba(255,255,255,0.05); font-size:11px; color:#486581;">
              <p style="margin:0 0 6px 0;">© 2026 A_S Commerce Inc. All rights reserved.</p>
      ...
      <td align="center" style="padding:48px 16px;">
        <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:540px; background:linear-gradient(180deg, #092032 0%, #051421 100%); border:1px solid rgba(212,175,55,0.35); border-radius:24px; box-shadow:0 24px 60px rgba(0,0,0,0.6); overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:36px 32px 24px 32px; border-bottom:1px solid rgba(255,255,255,0.06);">
              <div style="display:inline-block; padding:7px 18px; background:rgba(245,184,61,0.08); border:1px solid rgba(245,184,61,0.3); border-radius:30px; margin-bottom:14px;">
                <span style="font-size:10px; font-weight:800; letter-spacing:2.5px; color:#F5B83D; text-transform:uppercase;">ACCOUNT SECURITY</span>
              </div>
              <h1 style="margin:0; font-size:24px; font-weight:800; letter-spacing:4px; color:#FFFFFF; text-transform:uppercase; font-family:'Georgia', serif;">A_S COMMERCE</h1>
              <p style="margin:4px 0 0 0; font-size:10px; letter-spacing:2.5px; color:#D4AF37; text-transform:uppercase;">Luxury Concierge & Protection</p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding:36px 36px 32px 36px;">
              ...
              <p style="margin:0 0 32px 0; font-size:13.5px; line-height:1.65; color:#9FB3C8; max-width:400px;">
                We received a request to update the password for your A_S Commerce account. Click the secure button below to choose your new password:
              </p>
              <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto 32px auto;">
                <tr>
                  <td align="center" style="border-radius:14px; background:linear-gradient(135deg, #F5B83D 0%, #D4AF37 50%, #C29B27 100%); box-shadow:0 8px 24px rgba(245,184,61,0.25);">
                    <a href="${resetUrl}" style="display:inline-block; padding:15px 44px; font-size:13px; font-weight:800; color:#041019 !important; text-decoration:none; text-transform:uppercase; letter-spacing:1px; border-radius:14px;">Reset Password</a>
                  </td>
                </tr>
              </table>
